...
class Eigen(CMakePackage):
    ...
    version('64060da8461a627eb25b5a7bc0616776068db5d',git='https://github.com/cms-externals/eigen-git-mirror',
            commit='64060da8461a627eb25b5a7bc0616776068db5')
    ...
    def setup_dependent_environment(self, spack_env, run_env, dspec):
        spack_env.set('EIGEN_SOURCE','https://codeload.github.com/cms-externals/eigen-git-mirror/tar.gz/%s'%self.version)
