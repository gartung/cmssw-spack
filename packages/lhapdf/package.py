...
class Lhapdf(Package):
    ...
    url = "https://lhapdf.hepforge.org/downloads/LHAPDF-6.2.1.tar.gz"

    version('6.2.1', '9e05567d538fdb4862d4781cd076d7db')

    resource(name='cteq6l1', url='http://cmsrep.cern.ch/cmssw/repos/cms/SOURCES/slc7_amd64_gcc700/external/lhapdf/6.2.1/cteq6l1.tar.gz',
             md5='5611f1e9235151d9f67254aeb13bb65f')
    resource(name='CT10', url='http://cmsrep.cern.ch/cmssw/repos/cms/SOURCES/slc7_amd64_gcc700/external/lhapdf/6.2.1/CT10.tar.gz',
             md5='ec16da599329ad3525df040219c64538')
    resource(name='MSTW2008nlo68cl', url='http://cmsrep.cern.ch/cmssw/repos/cms/SOURCES/slc7_amd64_gcc700/external/lhapdf/6.2.1/MSTW2008nlo68cl.tar.gz',
             md5='929cd57dbcd8bae900c2bf694c529d75')
    resource(name='MMHT2014lo68cl', url='http://cmsrep.cern.ch/cmssw/repos/cms/SOURCES/slc7_amd64_gcc700/external/lhapdf/6.2.1/MMHT2014lo68cl.tar.gz',
             md5='25aae4cc0a0428de50fd6bdc5f7ff20b')
    resource(name='MMHT2014nlo68cl', url='http://cmsrep.cern.ch/cmssw/repos/cms/SOURCES/slc7_amd64_gcc700/external/lhapdf/6.2.1/MMHT2014nlo68cl.tar.gz',
